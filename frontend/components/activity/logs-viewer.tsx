...
export function LogsViewer() {
  ...
  useEffect(() => {
    ...
    const connect = () => {
      ...
      console.log(`Connecting to logs WebSocket: ${url}`)
      ...
      ws.onclose = () => {
        ...
        console.log(`Logs WebSocket closed; reconnect #${attempt} in ${delay}ms`)
  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 w-[600px] max-h-[600px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                size="icon"
                className="h-8 w-8"
                onClick={() => setFilter(filter === 'all' ? 'error' : filter === 'error' ? 'warning' : filter === 'warning' ? 'info' : 'all')}
                title="Filter"
              >
                ...
                filteredLogs.map((log, index) => (
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <Badge 
                        variant="outline" 
                        className={cn("text-[10px] h-4", getLogLevelColor(log.level))}
                      >
                        {log.level}
                      </Badge>
